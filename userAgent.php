<?php
/** *********************************************** ***********************************
* Hasilkan ratusan ribu Agen Pengguna seluler & desktop unik yang 100% asli.
* Mendukung Ratusan perangkat Android, versi 32 & 64 bit Windows XP-10.5, Linux 540-686, dan Mac 7-10.12
* serta browser Firefox, Chrome, dan Internet Explorer.
*/
kelas penggunaAgent {
    /**
     * Daftar Sistem Operasi Windows dengan versi dinamis
     * @var array $windows_os
     */
    publik  $ windows_os = [ '[Windows; |Jendela; kamu; |]Windows NT 6.:number0-3:;[ Win64; x64| WOW64| x64|]' ,
                           '[Jendela; |Jendela; kamu; |]Windows NT 10.:number0-5:;[ Win64; x64| WOW64| x64|]' , ];
    /**
     * Sistem Operasi Linux [terbatas]
     * @var array $linux_os
     */
    publik  $ linux_os = [ '[Linux; |][U; |]Linux x86_64' ,
                         '[Linux; |][U; |]Linux i:number5-6::number4-8::number0-6: [x86_64|]' ];
    /**
     * Sistem Operasi Mac (OS X) dengan versi dinamis
     * @var array $mac_os
     */
    publik  $ mac_os = [ 'Macintosh; [U; |]Intel Mac OS X :number7-9:_:number0-9:_:number0-9:' ,
                       'Jas hujan; [U; |]Intel Mac OS X 10_:number0-12:_:number0-9:' ];
    /**
     * Versi Android yang akan digunakan
     * @var array $AndroidVersions
     */
    publik  $ androidVersions = [ '4.3.1' ,
                                '4.4' ,
                                '4.4.1' ,
                                '4.4.4' ,
                                '5.0' ,
                                ...
                                '7.1.1' ];
    /**
     * Memegang versi android untuk Agen Pengguna yang dihasilkan
     * @ properti string $AndroidVersion
     */
    publik  $ androidVersion ;
    /**
     * Perangkat Android dan untuk versi android tertentu
    ...
    public function generate($userAgent = NULL) {
        ...
        if($userAgent == 'chrome') {
            ...
            return 'Mozilla/5.0 (' . $this->getMobileOS($userAgent) . ') AppleWebKit/' . (random_int(1, 100) > 50 ? random_int(533, 537) : random_int(600, 603)) . '.' . random_int(1, 50) . ' (KHTML, like Gecko)  Chrome/' . self::chromeVersion([ 'min' => 47 ,
                                                                                                                                                                                                                                                     'maks' => 55 ]) . ' Safari Seluler/' . ( random_int ( 1 , 100 ) > 50 ? random_int ( 533 , 537 ) : random_int ( 600 , 603 )) . '.' . random_int ( 0 , 9 );
        } lain {
            new  Exception ( 'Tidak dapat menentukan agen pengguna yang akan dihasilkan' );
        }
    }
}
